...
class Graphs(BaseSDK):
    ...
    def update(
        ...
        *,
        ...
        index_id: Optional[str] = None,
        metadata: Optional[
            Union[models.GraphUpdateMetadata, models.GraphUpdateMetadataTypedDict]
        ] = None,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        ...
        request = models.UpdateGraphRequest(
            id=id,
            body=models.GraphUpdate(
                name=name,
                description=description,
                index_id=index_id,
                metadata=utils.get_pydantic_model(
                    metadata, Optional[models.GraphUpdateMetadata]
                ),
            ),
        )
        ...
        req = self._build_request(
            ...
            security=self.sdk_configuration.security,
            get_serialized_body=lambda: utils.serialize_request_body(
                request.body, False, False, "json", models.GraphUpdate
            ),
            allow_empty_value=None,
            timeout_ms=timeout_ms,
        )
