...
class Generation(BaseSDK):
    ...
    def generate_triples(
        ...
        *,
    ...
    ) -> models.GenerateTriplesResponse:
        r"""Generate triples
        ...
        request = models.GenerateTriplesRequest(
            format_=format_,
        ...
        req = self._build_request(
            ...
            get_serialized_body=lambda: utils.serialize_request_body(
                request.body, False, False, "json", models.GenerateRequest
            ),
        ...
        http_res = self.do_request(
            ...
            request=req,
            error_status_codes=["400", "402", "4XX", "500", "5XX"],
            retry_config=retry_config,
        )

        response_data: Any = None
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(models.GenerateTriplesResponse, http_res)
